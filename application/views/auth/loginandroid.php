                    ...
                    <div class="form-group" > 
                        ...
                        <div class="form-group">
                            ...
                            <div class="fxt-transformY-50 fxt-transition-delay-4">  
                                <input type="button" class="fxt-btn-fill" name="" id="btnlogin" onclick="realizar_login()" value="Ingreso Android">
                                ...
                                <input type="button" class="fxt-btn-fill" name="" id="btnlogininvitado" onclick="realizar_login_invitado()" value="Ingresar como Invitado nuevo">
