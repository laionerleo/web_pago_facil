          ...
          <!-- <img id="baner" src="<?= $urlimagenbanner   ?>" class="card-img-top" alt="..."> -->
           <div class="card-body text-center">
               <div class="container row">
                 ...
                 <div class="col2 col-md-6 row " id="formulariotarjeta" >
                     ...
                     <div class="col-md-12" style="padding-bottom: 5px;"  >
                       ...
                       <div class="col-md-12 col-12">
                           <div class="controls" style="    text-align: justify;">
                             <input class="number form-control" id="creditCardNumber" data-cardinal-field="AccountNumber" name="creditCardNumber" type="text" ng-model="ncard" maxlength="19" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" >
                           </div>
                       </div>
                     </div>
                     ...
                     <div class="col-md-6" style="padding-bottom: 5px;"  >
                       ...
                       <div class="col-md-12 col-12">
                           <div class="controls" style="    text-align: justify;">
                             <input class="form-control inputname " id="billingFirst" type="text" placeholder="">
                           </div>
                       </div>
                     </div>
                     ...
                     <div class="col-md-6" style="padding-bottom: 5px;"  >
                       ...
                       <div class="col-md-12 col-12">
                           <div class="controls" style="    text-align: justify;">
                             <input class=" form-control inputname " id="billingLast" type="text" placeholder="">
                           </div>
                       </div>
                     </div>
                     ...
                     <div class="col-md-6" style="padding-bottom: 5px;"  >
                       ...
                       <div class="col-md-12 col-12">
                           <div class="controls" style="    text-align: justify;">
                             <input class="form-control expire " id="expirationDate" type="text" placeholder="MM / YYYY">
                           </div>
                       </div>
                     </div>
                     ...
                     <div class="col-md-6" style="padding-bottom: 5px;"  >
                       ...
                       <div class="col-md-12 col-12">
                           <div class="controls" style="    text-align: justify;">
                             <input class="  form-control ccv" style="width: 70;" id="cvvCode" type="text" placeholder="CVV" maxlength="3" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57">
                           </div>
                       </div>
                     </div>
                       ...
                       <div class="card-body">
                           <div class="row">
                               <div class="col-md-4 col-6 col-sm-4">
                                   ...
                                   <button id="btnprepararpago" class="btn btn-primary " onclick="starCCALast()" >Pagar  </button> </center>
                               </div>
                           </div>
                       </div>
                   </div>
...
/*
     ...
     //  $("#billingCountry").select2().val("<?= $tcPais ?>").trigger("change");
