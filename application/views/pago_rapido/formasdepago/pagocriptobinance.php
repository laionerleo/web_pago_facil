                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-xs-8">
                                                        ...
                                                        <div class="controls" style=" display: flex;">
                                                            <input id ="tcCodigoqr" class="form-control" readonly type="text"   value="" >                                                            
                                                            <button id="btncopiar" class="btn " onclick="copyToClipboard()"   ><svg class="copy-value"  width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.6001 0.2052H5.01367V2.58682H6.21367V1.4052H13.4001V11.0034H12.7889V12.2034H14.6001V0.2052ZM11.612 3.79999H1.99158V15.8001H11.612V3.79999ZM3.19158 14.6001V4.99999H10.412V14.6001H3.19158Z" fill="#009EE3"></path></svg></button>
                                                        </div>
                                                        
                                                        <a id="tcQrUrl"  target="_blank"   href=""> <h3>TICKET DE PAGO</h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-4 col-6 col-sm-4">
                                                    <center class="botones">
                                                        ...
                                                        <button id="bntprepararpago" class="btn btn-primary " onclick="generarqr()" >Generar pago  binance</button>
...
<script>
    ...
    var gosetintervaloconsulta;
        ...
        function generarqr()
        {
           // if(entidadesasignadas.length>0 )
            //{
                ...
                var urlajax=$("#url").val()+"/generarpagobinance";   
                    ...
                    dataType: "json",
                        ...
                        if(response.tipo==10)
                        {
                           ...
                           // $("#dateexpiracion").val(arrayqr.expirationDate);
                            $("#tcCodigoqr").val(response.lcDeepLink);
                            $("#tcQrUrl").attr("href",response.linkdescarga                        );
                           ...
                           // $("#elegirempresas").modal('toggle');
                            ...
                            $('#imagenqr').attr('src', `data:image/png;base64,${response.imagenqr}`);
        ...
        function copyToClipboard() {
                    var copyText = document.getElementById("tcCodigoqr");
                    copyText.select();
