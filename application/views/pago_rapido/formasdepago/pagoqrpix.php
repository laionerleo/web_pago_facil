                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-4 col-6 col-sm-4">
                                                    <center class="botones">
                                                        ...
                                                        <button id="bntprepararpago" class="btn btn-primary " onclick="generarqr()" >Generar Qr  PIX</button>
...
<script>
    ...
    var gosetintervaloconsulta;
        ...
        function generarqr()
        {
            ...
            var urlajax=$("#url").val()+"/generarqrpix";   
            ...
            $.ajax({                    
                    ...
                    dataType: "json",
                        ...
                        if(response.tipo==10)
                        {
                            ...
                            $("#tcCodigoqr").val(arrayqr.tcCodigoQr);
                            $("#tcQrUrl").attr("href",arrayqr.tcUrlQr);
