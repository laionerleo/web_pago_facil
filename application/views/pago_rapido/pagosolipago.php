...
@media screen and (min-width: 770px) {
    ...
    .titulos{
      ...
      <div class="card" style="margin-bottom: 1.2rem;">
              ...
              <?php  if( $_SESSION['ingresopagorapido']!=1 ) { 
                                            $this->load->view("pago_rapido/formasdepago/entidades");
                                          } ?>
              ...
              <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="form-row">
                                <?php  if($_SESSION['ingresopagorapido'] == 1 )  { ?>
                                        <div class="col-md-4 col-6 col-sm-4 col-lg-4">
                                            <center style="text-align: end;" ><button style="color: white;" class="btn btn-warning"  onclick="$('#confirmacion-tab').click();"> Atras</button> </center>
                                            
                                        </div>
                              <?php  }  ?>
                              <div class="col-md-3 col-6 col-sm-4">
                                <center> <button style="color: white;" class="btn btn-warning"  onclick="cancelarmetodopago()"> Cancelar</button>  </center>
                              ...
                              <div class="col-md-4 col-6 col-sm-4">
                                <center  class="botones" > 
                                    ...
                                    <button id="bntprepararpago" class="btn btn-primary "onclick="metodoprepararpago()">Pagar</button> </center>
...
function metodoprepararpago()
        {
            ...
            if( ($('#inpci').val().length>0)   &&  ($('#inpnumbersoli').val()!= 0) && ($('#inpci').val()>0)   &&   ($('#inpnumbersoli').val().length > 0)   && ($('#slcext').val()!= 0) )
            { 
                    ...
                    <?php  if( $_SESSION['ingresopagorapido']!=1 ) { ?>
                        ...
                        var datos= {ci:ci, complemento:complemento, extension:extension , fechaexpiracion :fechaexpiracion ,codigoservicio:codigoservicio ,numbersoli:numbersoli , tnEntidades:entidadesasignadas , tcCorreoEnvio:tcCorreoEnvio , tnNumeroEnvio :numbersoli,tcNombreCompleto:tcNombreCompleto };
                    <?php }else{ ?>
                    var datos= {ci:ci, complemento:complemento, extension:extension , fechaexpiracion :fechaexpiracion ,codigoservicio:codigoservicio ,numbersoli:numbersoli , tnEntidades:entidadesasignadas };
                    <?php } ?>
                    ...
                    dataType: "json",
                        ...
                        success:function(response) {
                            ...
                            if(response.tipo==1)
                                {
                                    swal("Mensaje", response.mensaje , "error");
                                    $("#textoresultado").text('ERROR EN EL PAGO');
                                    $("#textoresultado").text(response.mensaje);
                                    console.log(response);
                                    $('#vistaresultado').show();
                                    $("#resultado-tab").click();
